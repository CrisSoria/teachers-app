...
export default function RegisterPage() {
    return (
        <section className="bg-zinc-50 dark:bg-transparent flex items-center justify-center pt-5">
            <form
                action=""
                ...
                <div className="bg-card -m-px rounded-[calc(var(--radius)+.125rem)] border p-8 pb-6">
                    <div className="text-center">
                        ...
                        <h1 className="mb-1 mt-4 text-xl font-semibold">Registrate</h1>
                        <p className="text-sm">¡Bienvenido! Registrate para continuar</p>
                    </div>
