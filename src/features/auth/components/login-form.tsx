...
import { loginSchema } from "@/features/auth/interfaces/zod.schemas";
      ...
      >
        <div className="bg-card rounded-[calc(var(--radius)+.125rem)] border p-4 md:p-8 pb-6">
          <div className="text-center">
            ...
            <h1 className="mb-1 mt-4 text-xl font-semibold">Iniciar sesión</h1>
